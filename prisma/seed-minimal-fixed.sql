-- ============================================================================
-- Qavah-Mart Minimal Product Seed - Step by Step (FIXED)
...
-- STEP 2: Create Sellers (Run this second) - FIXED to generate IDs properly
-- ============================================================================
INSERT INTO sellers (id, "userId", "businessName", "businessType", "verificationStatus", rating, "totalSales", "responseTime", "joinedDate")
VALUES 
  (gen_random_uuid()::text, 'user_seed_001', 'Abebe''s Tech Store', 'individual', 'verified', 4.8, 45, 2, NOW() - INTERVAL '6 months'),
  (gen_random_uuid()::text, 'user_seed_002', 'Tigist Electronics', 'business', 'verified', 4.9, 62, 1, NOW() - INTERVAL '1 year'),
  (gen_random_uuid()::text, 'user_seed_003', 'Dawit Computer Shop', 'individual', 'verified', 4.7, 38, 3, NOW() - INTERVAL '8 months')
...
-- ============================================================================
-- After running step 3, you'll see seller IDs
