-- FINAL: Create Products with CORRECT seller IDs from database
-- ============================================================================
...
VALUES
  -- Product 1 - Dell XPS Laptop (Seller ID: a73b66bc-c2b2-4c16-87fc-f99951b4e119)
  (gen_random_uuid()::text,
   ...
   'a73b66bc-c2b2-4c16-87fc-f99951b4e119', NOW(), NOW()),
  
  -- Product 2 - HP Gaming Laptop (Seller ID: 9968cafe-2da2-4d6c-a98c-d2d3a1997854)
  (gen_random_uuid()::text,
  ...
  -- Product 3 - Lenovo ThinkPad (Seller ID: a6ee9bc1-a403-4467-9fd2-f2651bca1950a)
  (gen_random_uuid()::text,
  ...
  -- Product 4 - Gaming Desktop (Seller ID: a73b66bc-c2b2-4c16-87fc-f99951b4e119)
  (gen_random_uuid()::text,
  ...
  -- Product 5 - Intel Processor (Seller ID: 9968cafe-2da2-4d6c-a98c-d2d3a1997854)
  (gen_random_uuid()::text,
