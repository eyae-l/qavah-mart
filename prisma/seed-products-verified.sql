-- VERIFIED: Create Products with CORRECT seller IDs
-- ============================================================================
-- Run this ENTIRE query as ONE statement in Supabase SQL Editor
-- ============================================================================
...
VALUES
  ...
  -- Product 3 - Lenovo ThinkPad (FIXED: removed extra 'a' at end)
  (gen_random_uuid()::text,
   ...
   'a6ee9bc1-a403-4467-9fd2-f2651bca1950', NOW(), NOW()),
