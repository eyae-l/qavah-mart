-- ============================================================================
-- Qavah-Mart Simple Product Seed Data
...
-- Step 3: Seed Products (Using seller IDs directly from sellers table)
-- ============================================================================
...
SELECT 
  ...
  'Powerful laptop with Intel i7-12700H, 16GB RAM, 512GB SSD. Perfect for professionals and content creators. Excellent condition with minimal use.',
  85000,
  'new',
  'laptops',
  'business-laptops',
  ...
  NOW() - INTERVAL '2 days',
  NOW()
FROM sellers WHERE "userId" = 'user_seed_001';

INSERT INTO products (title, description, price, condition, category, subcategory, brand, images, status, views, favorites, city, region, country, specifications, "sellerId", "createdAt", "updatedAt")
SELECT 
  'HP Pavilion Gaming 15',
  'Gaming laptop with AMD Ryzen 5, GTX 1650, 8GB RAM. Great for gaming and everyday tasks. Lightly used, like new condition.',
  45000,
  'used',
  'laptops',
  'gaming-laptops',
  ...
  NOW() - INTERVAL '5 days',
  NOW()
FROM sellers WHERE "userId" = 'user_seed_002';

INSERT INTO products (title, description, price, condition, category, subcategory, brand, images, status, views, favorites, city, region, country, specifications, "sellerId", "createdAt", "updatedAt")
SELECT 
  'Lenovo ThinkPad X1 Carbon Gen 9',
  'Ultra-portable business laptop. Intel i5-1135G7, 16GB RAM, 256GB SSD. Perfect for professionals on the go.',
  72000,
  'refurbished',
  'laptops',
  'ultrabooks',
  ...
  NOW() - INTERVAL '1 day',
  NOW()
FROM sellers WHERE "userId" = 'user_seed_003';

INSERT INTO products (title, description, price, condition, category, subcategory, brand, images, status, views, favorites, city, region, country, specifications, "sellerId", "createdAt", "updatedAt")
SELECT 
  'ASUS ROG Strix G15 Gaming Laptop',
  'High-end gaming laptop with Ryzen 7, RTX 3060, 16GB RAM, 1TB SSD. RGB keyboard, 165Hz display. Excellent for gaming and streaming.',
  95000,
  'new',
  'laptops',
  'gaming-laptops',
  ...
  NOW() - INTERVAL '3 days',
  NOW()
FROM sellers WHERE "userId" = 'user_seed_004';

INSERT INTO products (title, description, price, condition, category, subcategory, brand, images, status, views, favorites, city, region, country, specifications, "sellerId", "createdAt", "updatedAt")
SELECT 
  'Acer Aspire 5 - Budget Laptop',
  'Affordable laptop for students and basic tasks. Intel i3, 8GB RAM, 256GB SSD. Good condition, perfect for everyday use.',
  28000,
  'used',
  'laptops',
  'budget-laptops',
  ...
  NOW() - INTERVAL '4 days',
  NOW()
FROM sellers WHERE "userId" = 'user_seed_005';

-- DESKTOP COMPUTERS
INSERT INTO products (title, description, price, condition, category, subcategory, brand, images, status, views, favorites, city, region, country, specifications, "sellerId", "createdAt", "updatedAt")
SELECT 
  'Dell OptiPlex 7090 Desktop',
  'Business desktop with Intel i7-11700, 16GB RAM, 512GB SSD. Perfect for office work and multitasking.',
  65000,
  'new',
  'desktop-computers',
  'workstations',
  'Dell',
  ARRAY['https://images.unsplash.com/photo-1587831990711-23ca6441447b'],
  'active',
  23,
  4,
  'Addis Ababa',
...
SELECT 
  ...
  'High-performance gaming PC. Ryzen 7 5800X, RTX 3070, 32GB RAM, 1TB NVMe + 2TB HDD. RGB lighting, liquid cooling.',
  125000,
  'new',
  'desktop-computers',
  'gaming-desktops',
...
SELECT 
  ...
  'Latest gen Intel processor, 6 cores 12 threads. Perfect for gaming and productivity builds. Brand new, sealed box.',
  18000,
  'new',
  'computer-components',
  'processors-cpus',
...
SELECT 
  ...
  'Excellent 1440p gaming GPU. 8GB GDDR6, ray tracing support. Lightly used for 6 months, works perfectly.',
  42000,
  'used',
  'computer-components',
  'graphics-cards-gpus',
  'NVIDIA',
  ARRAY['https://images.unsplash.com/photo-1591488320449-011701bb6704'],
  'active',
  134,
  22,
  'Hawassa',
...
SELECT 
  ...
  'High-performance DDR4 RAM, 3200MHz, RGB lighting. 2x8GB kit. Perfect for gaming builds.',
  8500,
  'new',
  'computer-components',
  'ram-memory',
  'Corsair',
  ARRAY['https://images.unsplash.com/photo-1541348263662-e068662d82af'],
  'active',
  45,
  7,
  'Mekelle',
...
SELECT 
  ...
  'Ultra-fast NVMe SSD, 3500MB/s read speed. Perfect for OS and games. Brand new, sealed.',
  12000,
  'new',
  'computer-components',
  'storage-drives',
  'Samsung',
  ARRAY['https://images.unsplash.com/photo-1597872200969-2b65d56bd16b'],
  'active',
  67,
  11,
  'Addis Ababa',
...
SELECT 
  ...
  'Popular gaming mouse with 25K DPI sensor, 11 programmable buttons, RGB lighting. Like new condition.',
  4500,
  'used',
  'peripherals',
  'mice',
  'Logitech',
  ARRAY['https://images.unsplash.com/photo-1527814050087-3793815479db'],
  'active',
  89,
  16,
  'Dire Dawa',
...
SELECT 
  ...
  'Premium mechanical gaming keyboard with green switches, RGB Chroma lighting. Excellent tactile feedback.',
  9500,
  'new',
  'peripherals',
  'keyboards',
  'Razer',
  ARRAY['https://images.unsplash.com/photo-1595225476474-87563907a212'],
  'active',
  72,
  13,
  'Bahir Dar',
...
SELECT 
  'Dell 27" 4K Monitor',
  'Professional 4K monitor, IPS panel, 60Hz. Perfect for productivity and content creation. Excellent color accuracy.',
  35000,
  'used',
  'peripherals',
  'monitors',
  'Dell',
  ARRAY['https://images.unsplash.com/photo-1527443224154-c4a3942d3acf'],
  'active',
  54,
  9,
  'Hawassa',
...
SELECT 
  ...
  'Popular HD webcam for video calls and streaming. 1080p 30fps, stereo audio. Great for remote work.',
  5500,
  'new',
  'peripherals',
  'webcams',
  'Logitech',
  ARRAY['https://images.unsplash.com/photo-1614624532983-4ce03382d63d'],
  'active',
  43,
  8,
  'Mekelle',
